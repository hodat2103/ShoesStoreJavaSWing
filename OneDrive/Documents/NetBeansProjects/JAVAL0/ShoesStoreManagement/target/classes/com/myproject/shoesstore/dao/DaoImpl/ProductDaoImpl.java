...
public class ProductDaoImpl implements ProductDao {
    ...
    public Product getCode(String code) {
        String sql = "SELECT product_code FROM tbl_product WHERE product_code = ?";
    ...
    public int updateQuantityProduct(String productCode, int quantity) {
        String selectSql = "SELECT quantity FROM tbl_product WHERE product_code = ?";

        String updateSql = "UPDATE tbl_product SET quantity = quantity - ? WHERE product_code = ?";
        int newQuantity = 0;
        int rows = 0;
        try {
