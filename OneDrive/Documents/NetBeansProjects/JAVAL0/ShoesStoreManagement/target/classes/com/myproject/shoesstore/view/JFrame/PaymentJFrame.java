...
import com.myproject.shoesstore.controller.PaymentController;
...
public class PaymentJFrame extends javax.swing.JFrame {
    ...
    public PaymentJFrame(InvoiceDetail invoiceDetail) {
        ...
        PaymentController paymentController = new PaymentController(btnExportInvoice, jtfCustomerPay, jlbRefund);
       
            paymentController.setView();
            paymentController.setEvent(invoiceDetail);
            dispose();
