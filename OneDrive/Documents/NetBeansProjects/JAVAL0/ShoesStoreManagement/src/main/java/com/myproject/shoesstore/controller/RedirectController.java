...
import com.myproject.shoesstore.view.LoginJFrame;
        ...
        public void mouseClicked(MouseEvent e) {
            switch (category) {
                ...
                case "Statistics":
                    ...
                    break;
                case "Logout":
                    int choice = JOptionPane.showConfirmDialog(null, "Bạn có muốn đăng xuất không?", "Thông báo", JOptionPane.YES_NO_OPTION);
                    ...
                    if (choice == JOptionPane.YES_OPTION) {
                        try {
                            ...
                            if (parent instanceof JFrame) {
                                JFrame currentFrame = (JFrame) parent;
                                currentFrame.dispose();
                                JFrame loginFrame = new LoginJFrame();
