...
import com.myproject.shoesstore.validation.DiscountValidation;
    ...
    public void setEvent() {
        btnSave.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (DiscountValidation.validDiscount(discount)) {

                    if (showDialog()) {
                        if (DiscountValidation.validCreateDiscountCode(jtfDiscountCode.getText(), discountService)) {
