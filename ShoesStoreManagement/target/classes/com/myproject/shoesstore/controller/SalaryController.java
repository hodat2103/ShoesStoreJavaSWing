...
public class SalaryController {
    ...
    try {
        ...
        double forfeit = Double.parseDouble(jtfBonuses.getText());

        double totalSalary = basicSalary + subsidy + bonuses - forfeit;

        jtfNetSalary.setText(String.valueOf(totalSalary));
